...
as expected, this case is equivalent to the case when $\writeset$ and $\readset$ are the set of propositional variables occuring in $\phi$.
...
On the other end of the spectrum, the case when $\writeset = \emptyset$ is of little interest since the only executable programs are the ones without assignements.
