...
which can be seen as an adaptation of lemma~\ref{theo:irrelevantVariables} to the $\progFlatten$ program.
...
\end{enumerate}
\noindent{} We conclude that $\modl \intPgm{\progFlatten(\pi_1, \pi2)} \modl'$.
...
\begin{enumerate}
  ...
  \item\label{pllequivalence:rtl:merge}
        ...
        The proof relies on Lemma~\ref{lem:progmerge}.
\end{enumerate}
\noindent{} We conclude that $\modl \intPgm{\pi_1 \pll \pi2} \modl'$.
\end{proof}
