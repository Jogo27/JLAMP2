...
\textbf{AH:} Qu'est-ce qu'un ``state where $p$ is undeterministically true or false'' ? ce serait pas plutot : ``...or non-deterministically lead to two possible states, one where $p$ is true and one where $p$ is false.'' ?
}
